---
title: Token Types
description: Complete reference for all TokenType values
draft: false
weight: 20
lang: en
type: doc
...
Complete reference for the `TokenType` enumeration. Each token type maps to a Pygments-compatible CSS class.
...
See [[docs/styling/css-classes|CSS Classes]] for the complete mapping.
